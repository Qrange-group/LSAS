...
__all__ = [
    ...
    "lsas_senet_resnet34",
    "lsas_senet_resnet50",
    "lsas_senet_resnet101",
    "lsas_senet_resnet152",
]
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False):
        ...
        self.layer3 = self._make_layer(block, 256, layers[2], stride=2, info="dsa")
        self.layer4 = self._make_layer(block, 512, layers[3], stride=2, info="dsa")
...
def lsas_senet_resnet18(pretrained=False, **kwargs):
...
def lsas_senet_resnet34(pretrained=False, **kwargs):
...
def lsas_senet_resnet50(pretrained=False, **kwargs):
...
def lsas_senet_resnet101(pretrained=False, **kwargs):
...
def lsas_senet_resnet152(pretrained=False, **kwargs):
